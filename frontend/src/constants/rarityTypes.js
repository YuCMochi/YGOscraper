...
export const RARITY_MAP = {
    ...
    '14': { short: 'GSE', full: 'ゴールドシークレットレア', zh: '黃金半鑽', color: '#adae29' },
    ...
    '22': { short: 'KC+R', full: 'KCレア', zh: 'KC銀字', color: '#346ecc' },
    ...
    '30': { short: 'M+SE', full: 'ミレニアムシークレットレア', zh: '半鑽古文', color: '#ce720e' },
    '31': { short: 'M+GR', full: 'ミレニアムゴールドレア', zh: '黃金古文鑽', color: '#ce720e' },
    '32': { short: 'P+EXSE', full: 'パラレルエクストラシークレットレア', zh: '斜鑽', color: '#957fd5' },
